...
class CreationOptions {
  ...
  static CreationOptions decode(Object result) {
    ...
    return CreationOptions(
      ...
      drmConfiguration: (result[3] as Map<Object?, Object?>?)!.cast<String, String>(),
...
class AndroidVideoPlayerApi {
  ...
  Future<String> getSigmaDeviceId() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.getSigmaDeviceId$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
