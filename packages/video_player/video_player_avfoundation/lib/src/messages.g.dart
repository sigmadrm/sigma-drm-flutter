...
class CreationOptions {
  ...
  static CreationOptions decode(Object result) {
    ...
    return CreationOptions(
      ...
      drmConfiguration: (result[2] as Map<Object?, Object?>?)!.cast<String, String>(),
    );
  }
...
class AVFoundationVideoPlayerApi {
  ...
  Future<String> getSigmaDeviceId() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.getSigmaDeviceId$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
